    ...
    <div id="productsContainer" class="row">
    	<div class="col-md-12">
	    	<div class="row pb-2 text-right">
	    		...
	    		<div class="col-md-4">
	    			<form method="GET" action="{{ url('/products/ui/add') }}">
            ...
            <div class="col-md-12 text-right">
            	<span v-for="page in paginationPage">
	            	<a :href="'products/page/'+page" class="mr-2" style="text-decoration: none; font-size: 20px;">
	            		@{{ page }}
	            	</a>
            	</span>
            </div>
